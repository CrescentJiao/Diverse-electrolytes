    ...
    public class FunctionalGraph : MaskableGraphic
    {
        ...
        public void Init()
        {
            ...
            Formulas = new List<FunctionFormula>
            {
             //  new FunctionFormula(Mathf.Sin, Color.red, 2.0f),
              ...
              new FunctionFormula(xValue=>-xValue*xValue*xValue +5/2*xValue *xValue ,Color.yellow,2.0f)
            };
        }
        ...
        public static void drawline()
        {
            ...
            foreach (var functionFormula in FunctionSetX.Formulas)
            {
                ...
                for (float x = -FunctionSetX._myRect.sizeDelta.x / 50.0f + 10; x < FunctionSetX.x + 10 / 50.0f; x += unitPixel)
                {
