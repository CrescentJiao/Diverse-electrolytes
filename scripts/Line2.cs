...
namespace SpringFramework22.UI
{
    ...
    public class Line2 : MaskableGraphic
    {
        ...
        public void Init()
        {
            ...
            Formulas2 = new List<FunctionFormula2>
            {
             //  new FunctionFormula(Mathf.Sin, Color.red, 2.0f),
              ...
              new FunctionFormula2(xValue=>-xValue+2 ,Color.yellow ,2.0f)
            };
        }
        ...
        public static void drawline()
        {
           ...
           // Debug.Log("this is in drawline of x!" + FunctionSetX2.Formulas2.ToString());
            ...
            {
                //FunctionSetX.x
                Vector2 startPos = functionFormula.GetResult(45, FunctionSetX2.GraphBase2.ScaleValue2);
                for (float x = -FunctionSetX2._myRect2.sizeDelta.x / 100.0f + 70; x < FunctionSetX2.x2 + 10 / 100.0f; x += unitPixel)
                {
                    Vector2 endPos = functionFormula.GetResult(x, FunctionSetX2.GraphBase2.ScaleValue2);
                    FunctionSetX2.vh22.AddUIVertexQuad(Line2.GetQuad(startPos, endPos, functionFormula.FormulaColor2, functionFormula.FormulaWidth2));
                    startPos = endPos;
                }
            }
