...
namespace SpringFramework11.UI
{
    ...
    public class Line1 : MaskableGraphic
    {
        ...
        public void Init()
        {
            _myRect = this.rectTransform;
                    ...
                    {      new FunctionFormula(xValue=>xValue+1 ,Color.yellow,2.0f)      };
        ...
        public static void drawline()
        {
            ...
            {
                //FunctionSetX.x
                Vector2 startPos = functionFormula.GetResult(0, FunctionSetX.GraphBase.ScaleValue);
                for (float x = -FunctionSetX._myRect.sizeDelta.x / 100.0f + 10; x < FunctionSetX.x + 10/ 40.0f; x += unitPixel)
                {
                    Vector2 endPos = functionFormula.GetResult(x, FunctionSetX.GraphBase.ScaleValue);
                    FunctionSetX.vh2.AddUIVertexQuad(Line1.GetQuad(startPos, endPos, functionFormula.FormulaColor, functionFormula.FormulaWidth));
                    startPos = endPos;
                }
            }
