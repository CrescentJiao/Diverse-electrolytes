...
namespace SpringFramework33.UI
{
    ...
    public class Line3 : MaskableGraphic
    {
        ...
        public void Init()
        {
            ...
            Formulas3 = new List<FunctionFormula3>
            {
             //  new FunctionFormula(Mathf.Sin, Color.red, 2.0f),
              ...
              new FunctionFormula3(xValue=>-xValue ,Color.green ,2.0f)
            };
        }
        ...
        public static void drawline()
        {
            ...
            foreach (var functionFormula in FunctionSetX3.Formulas3)
            {
                ...
                for (float x = -FunctionSetX3._myRect3.sizeDelta.x / 100.0f + 10; x < FunctionSetX3.x3 + 10 / 40.0f; x += unitPixel)
                {
                    Vector2 endPos = functionFormula.GetResult(x, FunctionSetX3.GraphBase3.ScaleValue3);
                    FunctionSetX3.vh23.AddUIVertexQuad(Line3.GetQuad(startPos, endPos, functionFormula.FormulaColor3, functionFormula.FormulaWidth3));
                    startPos = endPos;
                }
            }
