...
namespace SpringFramework2.UI
{
    ...
    public class FunctionalGraph2 : MaskableGraphic
    {
        ...
        public static void drawline()
        {
            ...
            {
                //FunctionSetX.x
                Vector2 startPos = functionFormula.GetResult(0, FunctionSetX2.GraphBase2.ScaleValue2);
                for (float x = -FunctionSetX2._myRect2.sizeDelta.x / 50.0f + 10; x < FunctionSetX2.x2 + 10 / 2.0f; x += unitPixel)
                {
