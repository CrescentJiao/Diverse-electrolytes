...
namespace SpringFramework44.UI
{
    ...
    /// </summary>
    [Serializable]
    public class FunctionSetX4
    {
        // public static float x;
        public static float x4;
        public static VertexHelper vh24;
        public static FunctionalGraphBase4 GraphBase4 = new FunctionalGraphBase4();
        public static List<FunctionFormula4> Formulas4;
        public static RectTransform _myRect4;
    }
    public class FunctionalGraphBase4
    {
        /// <summary>
        /// 是否显示刻度
        /// </summary>
        public bool ShowScale4 = false;

        /// <summary>
        /// XY轴刻度
        /// </summary>
        [Range(20f, 100f)] public float ScaleValue4 = 50f;
        /// <summary>
        /// 刻度的长度
        /// </summary>
        [Range(2, 10)] public float ScaleLenght4 = 5.0f;
        /// <summary>
        /// XY轴宽度
        /// </summary>
        [Range(2f, 20f)] public float XYAxisWidth4 = 2.0f;
        /// <summary>
        /// XY轴颜色
        /// </summary>
    ...
    /// </summary>
    [Serializable]
    public class FunctionFormula4
    {
        /// <summary>
        /// 函数表达式
        /// </summary>
        public Func<float, float> Formula4;
        /// <summary>
        /// 函数图对应线条颜色
        /// </summary>
        public Color FormulaColor4;
        public float FormulaWidth4;

        public FunctionFormula4() { }
        public FunctionFormula4(Func<float, float> formula, Color formulaColor, float width)
        {
            Formula4 = formula;
            FormulaColor4 = formulaColor;
            FormulaWidth4 = width;
        }

        public Vector2 GetResult(float xValue, float scaleValue)
        {
            return new Vector2(xValue, Formula4(xValue / scaleValue) * scaleValue);
        }
    }


    public class Line4 : MaskableGraphic
    {
        public FunctionalGraphBase4 GraphBase4 = new FunctionalGraphBase4();
        public List<FunctionFormula4> Formulas4;
        private RectTransform _myRect4;
        ...
        public void Init()
        {
            _myRect4 = this.rectTransform;
            Formulas4 = new List<FunctionFormula4>
            {
             //  new FunctionFormula(Mathf.Sin, Color.red, 2.0f),
              ...
              new FunctionFormula4(xValue=>xValue ,Color.green ,2.0f)
            };
        }
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            Init();
            vh.Clear();
            FunctionSetX4.vh24 = vh;


            #region 函数图的绘制
            FunctionSetX4._myRect4 = _myRect4;
            FunctionSetX4.GraphBase4 = GraphBase4;
            FunctionSetX4.Formulas4 = Formulas4;
            drawline();
        ...
        public static void drawline()
        {
            ...
            float unitPixel = 100 / FunctionSetX4.GraphBase4.ScaleValue4;
            foreach (var functionFormula in FunctionSetX4.Formulas4)
            {
                //FunctionSetX.x
                Vector2 startPos = functionFormula.GetResult(45, FunctionSetX4.GraphBase4.ScaleValue4);
                for (float x = -FunctionSetX4._myRect4.sizeDelta.x / 100.0f + 70; x < FunctionSetX4.x4 + 10 / 100.0f; x += unitPixel)
                {
                    Vector2 endPos = functionFormula.GetResult(x, FunctionSetX4.GraphBase4.ScaleValue4);
                    FunctionSetX4.vh24.AddUIVertexQuad(Line4.GetQuad(startPos, endPos, functionFormula.FormulaColor4, functionFormula.FormulaWidth4));
                    startPos = endPos;
                }
            }
